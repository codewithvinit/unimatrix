...
<footer class="main-footer">
    ...
    <div class="footer-left">
        Crafted with <i class="fa fa-fw fa-heart"></i> {$thisyear} <div class="bullet"></div> {$site_subname}<a href="https://codecanyon.net/item/unimatrix-membership-mlm-script/25882083">UniMatrix</a>
    </div>
